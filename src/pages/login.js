...
export default function Home() {
    ...
    return (
        <>
        <main className="d-flex align-items-center justify-content-center p-1">
            <form className="d-flex flex-column border-2 border p-4 gap-4 px-3 px-md-5" onSubmit={handleSubmit}>
